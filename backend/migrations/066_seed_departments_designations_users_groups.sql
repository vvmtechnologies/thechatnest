...
INSERT INTO users (email, name, mobile, password_hash, status, email_verified_at) VALUES
  ('sanjay.mishra@thechatnest.com', 'Sanjay Mishra', '+919800000001', '$2b$10$Q//e3Q5IHoUnSkH5gmCKE.4TM9QGk.R2njEBEjmfK.ycTAvBgr1Cm', 'active', NOW()),
  ('pooja.shah@thechatnest.com', 'Pooja Shah', '+919800000002', '$2b$10$Q//e3Q5IHoUnSkH5gmCKE.4TM9QGk.R2njEBEjmfK.ycTAvBgr1Cm', 'active', NOW()),
  ('karan.thakur@thechatnest.com', 'Karan Thakur', '+919800000003', '$2b$10$Q//e3Q5IHoUnSkH5gmCKE.4TM9QGk.R2njEBEjmfK.ycTAvBgr1Cm', 'active', NOW()),
  ('meera.iyer@thechatnest.com', 'Meera Iyer', '+919800000004', '$2b$10$Q//e3Q5IHoUnSkH5gmCKE.4TM9QGk.R2njEBEjmfK.ycTAvBgr1Cm', 'active', NOW()),
  ('rajesh.pandey@thechatnest.com', 'Rajesh Pandey', '+919800000005', '$2b$10$Q//e3Q5IHoUnSkH5gmCKE.4TM9QGk.R2njEBEjmfK.ycTAvBgr1Cm', 'active', NOW()),
  ('nisha.agarwal@thechatnest.com', 'Nisha Agarwal', '+919800000006', '$2b$10$Q//e3Q5IHoUnSkH5gmCKE.4TM9QGk.R2njEBEjmfK.ycTAvBgr1Cm', 'active', NOW()),
  ('dev.chauhan@thechatnest.com', 'Dev Chauhan', '+919800000007', '$2b$10$Q//e3Q5IHoUnSkH5gmCKE.4TM9QGk.R2njEBEjmfK.ycTAvBgr1Cm', 'active', NOW())
...
FROM users u WHERE u.email IN (
  'sanjay.mishra@thechatnest.com','pooja.shah@thechatnest.com','karan.thakur@thechatnest.com',
  'meera.iyer@thechatnest.com','rajesh.pandey@thechatnest.com','nisha.agarwal@thechatnest.com','dev.chauhan@thechatnest.com'
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'rahul.sharma@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Engineering' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'Software Engineer' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'amit.patel@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Engineering' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'DevOps Engineer' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'rohan.kumar@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Engineering' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'QA Engineer' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'dev.chauhan@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'priya.verma@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Design' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'UI/UX Designer' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'meera.iyer@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'neha.gupta@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Product' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'Business Analyst' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'kavita.joshi@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'ananya.reddy@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Marketing' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'Sales Executive' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'nisha.agarwal@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'vikram.singh@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'arjun.mehta@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'deepika.nair@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'sanjay.mishra@thechatnest.com') AND organization_id = 1;

-- Engineering extras
UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Engineering' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'Software Engineer' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'pooja.shah@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Engineering' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'Team Lead' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'karan.thakur@thechatnest.com') AND organization_id = 1;

UPDATE organization_members SET
  department_id = (SELECT department_id FROM departments WHERE name = 'Engineering' AND organization_id = 1 LIMIT 1),
  designation_id = (SELECT designation_id FROM designations WHERE name = 'Intern' AND organization_id = 1 LIMIT 1)
WHERE user_id = (SELECT user_id FROM users WHERE email = 'rajesh.pandey@thechatnest.com') AND organization_id = 1;
...
WHERE user_id = (SELECT user_id FROM users WHERE email = 'bhavesh.singh@thechatnest.com') AND organization_id = 1;
...
SELECT 'Engineering', 'Engineering team discussions — code reviews, deployments, tech decisions', 1,
  (SELECT user_id FROM users WHERE email = 'bhavesh.singh@thechatnest.com'), false, 'active'
...
SELECT 'Company Announcements', 'Official company updates — admins only can post', 1,
  (SELECT user_id FROM users WHERE email = 'bhavesh.singh@thechatnest.com'), true, 'active'
...
SELECT g.group_id, u.user_id, u.email IN ('bhavesh.singh@thechatnest.com','karan.thakur@thechatnest.com'), 1, 'active'
FROM groups g, users u
WHERE g.group_name = 'Engineering' AND g.organization_id = 1
  AND u.email IN ('bhavesh.singh@thechatnest.com','rahul.sharma@thechatnest.com','amit.patel@thechatnest.com','rohan.kumar@thechatnest.com','pooja.shah@thechatnest.com','karan.thakur@thechatnest.com','dev.chauhan@thechatnest.com','rajesh.pandey@thechatnest.com')
ON CONFLICT (group_id, user_id) DO UPDATE SET status = 'active';

-- Add members to Product & Design group
INSERT INTO group_members (group_id, user_id, is_admin, organization_id, status)
SELECT g.group_id, u.user_id, u.email IN ('bhavesh.singh@thechatnest.com','neha.gupta@thechatnest.com'), 1, 'active'
FROM groups g, users u
WHERE g.group_name = 'Product & Design' AND g.organization_id = 1
  AND u.email IN ('bhavesh.singh@thechatnest.com','neha.gupta@thechatnest.com','priya.verma@thechatnest.com','meera.iyer@thechatnest.com','kavita.joshi@thechatnest.com')
ON CONFLICT (group_id, user_id) DO UPDATE SET status = 'active';

-- Add ALL members to Company Announcements
INSERT INTO group_members (group_id, user_id, is_admin, organization_id, status)
SELECT g.group_id, u.user_id, u.email = 'bhavesh.singh@thechatnest.com', 1, 'active'
FROM groups g, users u
WHERE g.group_name = 'Company Announcements' AND g.organization_id = 1
  AND u.email LIKE '%@thechatnest.com'
ON CONFLICT (group_id, user_id) DO UPDATE SET status = 'active';

-- Add members to Marketing & Sales group
INSERT INTO group_members (group_id, user_id, is_admin, organization_id, status)
SELECT g.group_id, u.user_id, u.email IN ('bhavesh.singh@thechatnest.com','ananya.reddy@thechatnest.com'), 1, 'active'
FROM groups g, users u
WHERE g.group_name = 'Marketing & Sales' AND g.organization_id = 1
  AND u.email IN ('bhavesh.singh@thechatnest.com','ananya.reddy@thechatnest.com','nisha.agarwal@thechatnest.com','arjun.mehta@thechatnest.com','vikram.singh@thechatnest.com')
ON CONFLICT (group_id, user_id) DO UPDATE SET status = 'active';
