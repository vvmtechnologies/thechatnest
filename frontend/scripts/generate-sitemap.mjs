...
const ROUTES = [
  ...
  { path: "/blogs", priority: 0.75, changefreq: "weekly" },
  { path: "/help", priority: 0.7, changefreq: "weekly" },
  { path: "/versions", priority: 0.7, changefreq: "weekly" },
  { path: "/channel-partner", priority: 0.7, changefreq: "monthly" },
  ...
  { path: "/on-premise-privacy", priority: 0.4, changefreq: "yearly" },
  { path: "/air-gapped-privacy", priority: 0.4, changefreq: "yearly" },
