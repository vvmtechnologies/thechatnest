...
const ROUTES = [
  ...
  { path: "/brochure", priority: 0.85, changefreq: "weekly" },
  ...
  { path: "/why-thechatnest", priority: 0.75, changefreq: "monthly" },
  { path: "/referrals", priority: 0.7, changefreq: "monthly" },
  { path: "/for-engineering", priority: 0.8, changefreq: "monthly" },
  { path: "/for-sales", priority: 0.8, changefreq: "monthly" },
  { path: "/for-remote", priority: 0.8, changefreq: "monthly" },
